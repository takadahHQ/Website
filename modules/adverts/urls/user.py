...
from modules.adverts.views import user as views

urls = [
    path('show/<str:original_page_url>/', views.AdvertisementPageView.as_view(), name='advertisement'),
    path('goto/<int:ad_id>/', views.RecordClickAndRedirectView.as_view(), name='goto'),
