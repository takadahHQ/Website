    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ManyToManyField(blank=True, related_name='authors', through='stories.Author', to=settings.AUTH_USER_MODEL)),
                ('characters', models.ManyToManyField(blank=True, related_name='names', to='stories.character')),
                ('dislikes', models.ManyToManyField(blank=True, related_name='story_dislike', to=settings.AUTH_USER_MODEL)),
                ('editor', models.ManyToManyField(blank=True, related_name='editors', through='stories.Editor', to=settings.AUTH_USER_MODEL)),
                ...
                ('language', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stories.language')),
                ('likes', models.ManyToManyField(blank=True, related_name='story_likes', to=settings.AUTH_USER_MODEL)),
                ('rating', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='stories.rating')),
                ('story_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stories.type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chapter', to='stories.chapter')),
        ...
        migrations.AddField(
            ...
            name='category_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='stories.type'),
        ),
        migrations.CreateModel(
            name='Bookmark',
            fields=[
